...
Under the probabilistic model of Poisson regression, the expected
frequency of a language with feature values $f_1, ..., f_m$ is}
%
\nonumber
  \lambda &= e^V\\
\intertext{with $V$ as in Equation~\ref{eq:V}.
The probability that such a language will be observed to have frequency $F$ is:}
%
  \label{eq:p}
